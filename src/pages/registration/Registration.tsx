...
import { RegistrationHeroPanel } from './RegistrationHeroPanel.tsx';
...
export const Registration = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      <RegistrationHeroPanel />

      {/* ── Right — form ── */}
      <section className="flex flex-col w-full md:w-[440px] md:flex-none bg-white overflow-y-auto px-8 py-8">
        <div className="w-full max-w-sm mx-auto flex flex-col justify-center min-h-full">
          ...
          <div className="mb-5">
            <h2 className="font-display text-2xl font-bold mb-1" style={{ color: 'var(--stone)' }}>
              Créer un compte
            </h2>
