...
import type { CreateBudgetExpenseInput } from '../../../stores/bank-accounts/bank-accounts.types';

interface AddBudgetExpenseDialogProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (input: CreateBudgetExpenseInput) => void;
  isPending: boolean;
}
...
export const AddBudgetExpenseDialog = ({
  open,
  onClose,
  onSubmit,
  isPending,
  ...
  const {
    ...
    mode: 'onChange',
    defaultValues: { description: '', amount: 0, expenseDate: today, debitDate: today },
  });
