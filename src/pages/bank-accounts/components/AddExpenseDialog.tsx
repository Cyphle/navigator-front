...
import type { CreateExpenseInput } from '../../../stores/bank-accounts/bank-accounts.types';
...
export const AddExpenseDialog = ({ open, onClose, onSubmit, isPending }: AddExpenseDialogProps) => {
  const {
    control,
    handleSubmit,
    reset,
